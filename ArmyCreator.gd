...
func create_soldier_A(stamina, hp): 
	...
	print("A position: " + str(soldier.position))
	print("A intended position: " + str(soldier.expected_x_position))
...
func create_soldier_B(stamina, hp): 
	...
	print("B position: " + str(soldier.position))
	print("B intended position: " + str(soldier.expected_x_position))
	soldier.set_sprite_idle()
	soldier.face_left()
